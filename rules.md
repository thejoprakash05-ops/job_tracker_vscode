...
These rules are applied every time the resume is tailored for a job. Follow them exactly — they override the source resume content.

1. **Remove "Cross-Functional Orchestration"**: Delete the bullet point that begins with "Cross-Functional Orchestration" from every section it appears in. Do not include it in the output at all.
